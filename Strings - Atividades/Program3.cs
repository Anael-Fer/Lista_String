...
namespace atv3
{
    class Program
    {
        ...
        static string Descriptografar(string texto, int chave)
        {
            string resultado = "";
            ...
            {
                int valorASCII = texto[i];
                int novoValorASCII = (valorASCII - chave + 256) % 256;  // Reverte a criptografia
                resultado += ConverterCaractere(novoValorASCII);  // Converte e adiciona ao resultado
            }
        ...
        static void Main(string[] args)
        {
            ...
            Console.Write("Digite a string a ser criptografada/descriptografada: ");
